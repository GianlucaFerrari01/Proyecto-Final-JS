...
function selector() {
    ...
    const categorias = ["INGRESANTE", "OPERARIO CALIFICADO", "MEDIO OFICIAL", "OPERARIO ESPECIALIZADO", "OPERARIO ESPDO MÚLTIPLE", "OFICIAL", "OFICIAL MÚLTIPLE"];
...
function horasExtrasTrabajadas() {
    const hexT = ""
